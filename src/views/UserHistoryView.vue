...
.history-bg {
  ...
  position: relative; /* 讓 GuideButton 有定位參考 */
}
...
.history-content {
  ...
  flex-direction: column;
  align-items: center;
  padding: 3rem 0.7rem 1.2rem 0.7rem; /* 頂部留空間給 GuideButton */
  box-sizing: border-box;
  overflow-y: auto;
}
...
@media (max-width: 300px) {
  .history-content {
    padding: 2rem 0.4rem 0.8rem 0.4rem; /* 2vh -> 2rem */
  }
...
@media (max-width: 200px) {
  .history-content {
    padding: 1.33rem 0.27rem 0.53rem 0.27rem; /* 2rem * 2/3 */
  }
  ...
  .record-row {
    border-radius: 0.33rem; /* 8px * 2/3 */
    padding: 0.33rem 0.5rem;
    font-size: 0.67rem; /* 1rem * 2/3 */
    
    .exchange-arrow {
      flex: 0 0 2rem; /* 40px * 2/3 ≈ 27px */
      font-size: 1.07rem; /* 1.6rem * 2/3 */
